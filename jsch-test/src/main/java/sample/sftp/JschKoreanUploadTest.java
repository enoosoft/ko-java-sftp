 ...
 *   - EUC-KR 송출 : 한글 1자 = 2바이트 → 같은 EUC-KR 을 쓰는 AIX/HP-UX/Solaris
 *                   클라이언트끼리는 정상 표시됨
 ...
 *
 *   encoding 기본값: EUC-KR (AIX/HP-UX/Solaris 의 ko_KR.eucKR locale 표준).
 *   대조군 비교용으로 UTF-8 / ISO-8859-1 도 지정 가능.
 */
public class JschKoreanUploadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encoding = args.length >= 6 ? args[5] : "EUC-KR";

        String remoteFilename = "한_[mwiede-jsch-0.2.25-" + encoding + "]_" + System.currentTimeMillis() + ".txt";
